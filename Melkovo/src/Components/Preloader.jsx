	...
	render(){
		return(
				<div id='preloader'>
					...
					<div className="preloader__wrap-logo">
							<svg className="preloader__logo" x="0px" y='0px'
							...
							<div className="preloader__logo-name">
								Мелково
								<br/>
								<span>меха</span>
					...
					<div className='preloader__wrap-rect'>
