...
!function (e, t) {
  ...
  var t,
    ...
    "#" === e.charAt(0) && (e = e.substr(1));for (var t, n = String(e), o = n.length, r = -1, a = "", c = n.charCodeAt(0); ++r < o;) {
      if (0 === (t = n.charCodeAt(r))) throw new InvalidCharacterError("Invalid character: the input contains U+0000.");a += t >= 1 && t <= 31 || 127 == t || 0 === r && t >= 48 && t <= 57 || 1 === r && t >= 48 && t <= 57 && 45 === c ? "\\" + t.toString(16) + " " : t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 || t >= 65 && t <= 90 || t >= 97 && t <= 122 ? n.charAt(r) : "\\" + n.charAt(r);
    }return "#" + a;
  },
      p = function p(e, t) {
    ...
    var i = v(o ? o.getAttribute("data-options") : null),
      ...
      var m = e.pageYOffset;u.selectorHeader && !r && (r = document.querySelector(u.selectorHeader)), a || (a = O(r));var b,
          ...
          j = 0,
          C = function C(t, r, a) {
        var c = e.pageYOffset;(t == r || c == r || e.innerHeight + c >= A) && (clearInterval(a), S(n, r, d), u.callback(n, o));
      },
          M = function M() {
...
(0, _jquery2.default)(document).ready(function () {
	...
	(function () {
		if (document.documentElement.clientWidth > 1100) {
			(0, _jquery2.default)('.faq-wrap-accordeon dd').prev().click(function () {
				(0, _jquery2.default)('.faq-wrap-accordeon').find('.accordeon-ask').css('color', '#fff').next().text('+');
				(0, _jquery2.default)(this).find('.accordeon-ask').css('color', '#e8bf5d').next().text('-');
				(0, _jquery2.default)('.faq-wrap-accordeon dd').not(this).css({ 'opacity': 0, 'z-index': 0 });
				(0, _jquery2.default)(this).next().css({ 'opacity': 1, 'z-index': 1 });
			});

			(0, _jquery2.default)('.faq-wrap-accordeon dd').css('opacity', 0);
			(0, _jquery2.default)('.faq-wrap-accordeon dd').first().css({ 'opacity': 1, 'z-index': 1 });
			(0, _jquery2.default)('.faq-wrap-accordeon .accordeon-ask').first().css('color', '#e8bf5d').next().text('-');
		} else {
			(0, _jquery2.default)('.faq-wrap-accordeon dd').css('height', 0).prev().click(function () {
				(0, _jquery2.default)('.faq-wrap-accordeon').find('.accordeon-ask').css('color', '#fff').next().text('+');
				(0, _jquery2.default)(this).find('.accordeon-ask').css('color', '#e8bf5d').next().text('-');
				(0, _jquery2.default)('.faq-wrap-accordeon dd').not(this).css('height', 0);
				(0, _jquery2.default)(this).next().css('height', 200);
			});

			(0, _jquery2.default)('.faq-wrap-accordeon dd').first().css('height', 200);
	...
	// smooth scroll
	(0, _jquery2.default)('.nav-item a').click(function () {
		(0, _jquery2.default)('.nav-item a').removeClass('active');
